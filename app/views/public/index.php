            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex" id="form-login" method="POST" action="../../controllers/LoginController.php">
                        <input class="form-control" type="text" placeholder="User" aria-label="User" name="input-user" id="input-login">
                        <input class="form-control" type="password" placeholder="Password" aria-label="Password" name="input-password" id="input-login">
...
//                    echo '<form action="../../controllers/RestauranteController.php" method="POST"><input type="hidden" name="type" value="DELETE"><input type="hidden" name="id" value="'.$restaurante->getId().'"><button class="btn btn-danger" type="submit">Borrar</button></form>';
//                    echo '</div>';
                    echo '</div>';
                    echo '</div>';
                }
