...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["type"]) && $_POST["type"] == "NUEVO" && isset($_SESSION["tipoUser"]))  {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["type"]) && $_POST["type"] == "EDITAR" && isset($_SESSION["tipoUser"])) {
